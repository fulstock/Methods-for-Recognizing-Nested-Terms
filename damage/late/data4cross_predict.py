...
original_data = "S:/HRCode/data/RuTermEval/track3/flat/pure/train.json" 
damaged_data = "S:/HRCode/data/RuTermEval/track3/flat/damage2/" + method + "/" + mask + "/train.json"
parted_data = "S:/HRCode/data/RuTermEval/track3/flat/parted2/" + method + "/" + mask
...
for part in range(total_parts):
    train_lines = [o for o_idx, o in enumerate(origlines) if o_idx < part_paired_delims[part][0] or o_idx > part_paired_delims[part][1]]
    predict_lines = [d for d_idx, d in enumerate(dmglines) if d_idx >= part_paired_delims[part][0] and d_idx <= part_paired_delims[part][1]]
