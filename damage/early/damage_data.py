...
original_flatdata = "S:/HRCode/data/RuTermEval/track2/flat/pure"
new_data = "S:/HRCode/data/RuTermEval/track2/flat/damage/" + method + "/" + mask
...
for dataset in datasets:
    ...
    for line in tqdm(origfile.readlines()):
        ...
        #print(new_text)
        #for s, e, t in updated_kept_entities:
            #print(t, new_text[s : e])
        #print(kept_entities)
    ...
    origfile.close()
    newfile.close()
    print("Damaged:", all_count - kept_count)
    print("Kept:", kept_count)
    print("All:", all_count)
