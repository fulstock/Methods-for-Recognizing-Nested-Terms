...
damage_data_file = "./damage2/converted/" + track + "-middle-diglets.json"
...
if not os.path.exists(os.path.join("S:/HRCode/data/RuTermEval", track, "flat/lemwincdamage2")):
    os.makedirs(os.path.join("S:/HRCode/data/RuTermEval", track, "flat/lemwincdamage2"), exist_ok = True)

with open(os.path.join("S:/HRCode/data/RuTermEval", track, "flat/lemwincdamage2", "train.json"), "w", encoding = "UTF-8") as train_file:
    for data in train_data:
        train_file.write(json.dumps(data, ensure_ascii = False) + "\n")

with open(os.path.join("S:/HRCode/data/RuTermEval", track, "flat/lemwincdamage2", "dev.json"), "w", encoding = "UTF-8") as dev_file:
    for data in dev_data:
        dev_file.write(json.dumps(data, ensure_ascii = False) + "\n")

with open(os.path.join("S:/HRCode/data/RuTermEval", track, "flat/lemwincdamage2", "test.json"), "w", encoding = "UTF-8") as test_file:
